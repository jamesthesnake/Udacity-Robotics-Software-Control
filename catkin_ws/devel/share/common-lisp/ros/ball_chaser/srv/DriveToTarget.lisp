...
(cl:ensure-generic-function 'round_y-val :lambda-list '(m))
(cl:defmethod round_y-val ((m <DriveToTarget-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ball_chaser-srv:round_y-val is deprecated.  Use ball_chaser-srv:round_y instead.")
  (round_y m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <DriveToTarget-request>) ostream)
  ...
  (cl:let ((bits (roslisp-utils:encode-double-float-bits (cl:slot-value msg 'round_y))))
    (cl:write-byte (cl:ldb (cl:byte 8 0) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 8) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 16) bits) ostream)
    (cl:write-byte (cl:ldb (cl:byte 8 24) bits) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DriveToTarget-request>) istream)
  "Deserializes a message object of type '<DriveToTarget-request>"
    ...
    (cl:let ((bits 0))
      ...
      (cl:setf (cl:ldb (cl:byte 8 48) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 56) bits) (cl:read-byte istream))
    (cl:setf (cl:slot-value msg 'round_y) (roslisp-utils:decode-double-float-bits bits)))
    (cl:let ((bits 0))
      (cl:setf (cl:ldb (cl:byte 8 0) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) bits) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) bits) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DriveToTarget-request>)))
  ...
  "53690aee229ef9c5c30bfcb42fe333b6")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DriveToTarget-request)))
  "Returns md5sum for a message object of type 'DriveToTarget-request"
  "53690aee229ef9c5c30bfcb42fe333b6")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<DriveToTarget-request>)))
  ...
  (cl:format cl:nil "float64 linear_x~%float64 round_y~%float64 angular_z~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'DriveToTarget-request)))
  "Returns full string definition for message of type 'DriveToTarget-request"
  (cl:format cl:nil "float64 linear_x~%float64 round_y~%float64 angular_z~%~%~%"))
