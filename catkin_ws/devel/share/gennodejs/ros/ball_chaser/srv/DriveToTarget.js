...
class DriveToTargetRequest {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('round_y')) {
        this.round_y = initObj.round_y
      }
      else {
        this.round_y = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [round_y]
    bufferOffset = _serializer.float64(obj.round_y, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [round_y]
    data.round_y = _deserializer.float64(buffer, bufferOffset);
  ...
  static md5sum() {
    ...
    return 'c3a98c4f08598401e04daea21d9727d7';
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.round_y !== undefined) {
      resolved.round_y = msg.round_y;
    }
    else {
      resolved.round_y = 0.0
    }
...
module.exports = {
  ...
  md5sum() { return '53690aee229ef9c5c30bfcb42fe333b6'; },
