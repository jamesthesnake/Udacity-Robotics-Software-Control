...
class DriveToTargetRequest(genpy.Message):
  _md5sum = "c3a98c4f08598401e04daea21d9727d7"
...
float64 angular_z
"""
  __slots__ = ['linear_x','round_y','angular_z']
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_3d().pack(_x.linear_x, _x.round_y, _x.angular_z))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.linear_x, _x.round_y, _x.angular_z,) = _get_struct_3d().unpack(str[start:end])
      return self
...
class DriveToTarget(object):
  ...
  _md5sum = '53690aee229ef9c5c30bfcb42fe333b6'
